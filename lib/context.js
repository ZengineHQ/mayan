...
function createNewContext(argv, mayaJSON) {
  ...
  // strip http:// and https:// to avoid issues with misconfigured mayan
  ctx.apiEndpoint = ctx.apiEndpoint.replace('https://', '')
  ctx.apiEndpoint = ctx.apiEndpoint.replace('http://', '')
