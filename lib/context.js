...
function createNewContext (argv, mayaJSON) {
  ...
  if (ctx.apiEndpoint.indexOf('://') >= 0) {
    ctx.apiEndpoint = ctx.apiEndpoint.substring(ctx.apiEndpoint.indexOf('://') + 3)
    console.log(kleur.yellow('Your API Endpoint should not contain https://. We removed it for you but you should update your example.mayan.json.'))
  }
