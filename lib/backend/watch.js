...
module.exports = async argv => {
  ...
  function tearDownListeners(proxyServers) {
    ...
    process.on('uncaughtException', error => console.log('An Uncaught Exception occurred:', error) || cleanup())
    process.on('unhandledRejection', error => console.log('An Unhandled Rejection occurred:', error) || cleanup())
