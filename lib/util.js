...
exports.printError = location => err => {
  if (err instanceof Error || typeof err === 'string') {
    return console.error(`Error at ${location}`, err)
  }
  ...
  try {
    ...
    if (!message || message === '{}') {
      return console.error(`An Unexpected Error Occurred at ${location}:`, err || '(error message not available)')
    }
